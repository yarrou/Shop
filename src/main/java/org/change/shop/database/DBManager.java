...
public class DBManager {
    ...
    public void saveCustomer(Customer customer) throws SQLException {
        ...
        if(((Integer)customer.getId() == null) ||(customer.getId()== -1)) {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement("update customers set name=?,email = ?,city = ?, age = ? where id = ?");
            preparedStatement.setString(1,customer.getName());
            preparedStatement.setString(2,customer.getEmail());
            preparedStatement.setString(3,customer.getCity());
            preparedStatement.setInt(4,customer.getAge());
    ...
    public Purchase getPurchase(int id) throws SQLException {
        PreparedStatement preparedStatement = conn.prepareStatement("select * from purchases where id = ?");
        preparedStatement.setInt(1,id);
        ResultSet resultSet = preparedStatement.executeQuery();
        resultSet.next();
    ...
    public void deletePurchase( Purchase purchase) throws SQLException {
        PreparedStatement preparedStatement = conn.prepareStatement("delete from purchases where id = ?");
    ...
    public void savePurchase(Purchase purchase) throws SQLException{
        if(((Integer)purchase.getId() == null) ||(purchase.getId()== -1)) {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement("update purchases set customer_id =?,product_id = ?,date = ? where id = ?");
            preparedStatement.setInt(1,purchase.getCustomer_id());
            preparedStatement.setInt(2,purchase.getProduct_id());
            preparedStatement.setString(3,purchase.getDate());
    ...
    public Product getProduct(int id) throws SQLException{
        PreparedStatement preparedStatement = conn.prepareStatement("select * from products where id = 7");
        preparedStatement.setInt(1,id);
        ResultSet resultSet = preparedStatement.executeQuery();
        resultSet.next();
    ...
    public void saveProduct(Product product) throws SQLException{
        if(((Integer)product.getId() == null) ||(product.getId()== -1)) {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement("update products set name = ?,price = ?,note = ? where id = ?");
            preparedStatement.setString(1,product.getName());
            preparedStatement.setInt(2,product.getPrice());
            preparedStatement.setString(3,product.getNote());
